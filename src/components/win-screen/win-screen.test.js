...
describe(`Test WinScreen`, () => {
  ...
  it(`WinScreen renders correctly`, () => {
    ...
    expect(screen.getByText(/Вы ответили правильно/i)).toHaveTextContent(correctAnswersCount);
    expect(screen.getByText(/Вы ответили правильно/i)).toHaveTextContent(mistakes);
  });

  it(`When user click 'Replay' button compenent should redirect`, () => {
